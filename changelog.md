...
Score mode selected from hub Section 5 — syncs to overlay automatically within 8 seconds
Each row shows rank (top 3 highlighted), player name in team colour, active score, K/D, and side
Column header shows full score name (COMBAT / OFFENSIVE / DEFENSIVE / SUPPORT)
Respects swap sides config from hub
Added Section 5 "Top 10 Score Mode" to hub with four buttons to control the scoreboard
Hub section numbering shifted accordingly (Ticker Messages now Section 6, etc.)
v2.0.2
