...
- All artillery correctly excluded across all overlays: sfh, howitzer, lefh, brumm, stuh, strumpanzer, 105mm, 122mm, 150mm, 152mm, 155mm
- Brummbar correctly identified as SPA artillery in all overlays and killfeed
- All 22 tanks correctly detected and named for all 4 factions (US, German, Soviet, British)
- Bracket-priority weapon lookup prevents false tank type detection (Panzer IV/Panther no longer show as Sherman)
...
- New installer — GUI installer (.exe) with progress bar, automatic Python detection and install, settings backup and restore, desktop shortcut creation
- Desktop shortcut now opens browser automatically when server starts
- Auto-updater re-enabled — checks for updates on every launch
